 ...
 */
final class DuckDomain {

	private DuckDomain() {
	}

	abstract static class AbstractComponent {
		final String id;
	...
	static final class DuckConcept extends AbstractComponent implements Concept {
	...
	static final class DuckDescription extends AbstractComponent implements Description {
	...
	static final class DuckRelationship extends AbstractComponent implements Relationship {
	...
	static final class DuckOntologyAxiom extends AbstractComponent implements OntologyAxiom {
	 ...
	 */
	static final class DuckAnnotation extends AbstractComponent implements Annotation {
		private final String conceptId;
